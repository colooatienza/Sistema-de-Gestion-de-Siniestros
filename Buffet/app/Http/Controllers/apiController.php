    ...
    public function mostrar(){
        ...
        switch ($cmd) {
                ...
                case '/help':
                        ...
                        $msg['text'] .= '/actual Muestra el menú del día' . PHP_EOL;
                        $msg['text'] .= '/proximo Muestra el menú de mañana' . PHP_EOL;
                        $msg['text'] .= '/help Muestra esta ayuda' . PHP_EOL;
                        $msg['text'] .= '/suscribirse Suscribirse a las notificaciones del menú diario' . PHP_EOL;
                        $msg['text'] .= '/desuscribirse Cancelar las notificaciones del menú diario' . PHP_EOL;
                        $msg['reply_to_message_id'] = null;
                        break;
                default:
        ...
        $url = 'https://api.telegram.org/bot352134267:AAE_3drox_uKjXFOMj6X8-fD2_7hp19gQ6M/sendMessage';
        $options = array(
                'http' => array(
