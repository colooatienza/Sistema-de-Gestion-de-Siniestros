$(document).ready(
  ...
  alert(err.Message);
    ...
    function(){
      ...
      '<br/><br/> <select name="producto'+contador+'" id="productos'+contador+'" required>     <option>Seleccione producto</option>  </select> <br/><br/> <p>Precio unitario:</p>'+
      '<input type= "number" value="0.00" step="0.01" name="precio'+contador+'" class="imputForm">  <p>Cantidad:</p>  <input type="number" value="1" name="cantidad'+contador+'"'+
